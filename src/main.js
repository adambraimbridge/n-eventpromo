...
async function eventPromoInit (root) {
	const promoDataSelector = root.querySelector('.js-event-promo-data');
	const promoSlotSelector = root.querySelector('.js-event-promo');
